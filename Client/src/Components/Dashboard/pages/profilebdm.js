...
export function Profilebdm(){
    ...
    function handleupdateglprofile(event){
        ...
        //   console.log("key",key)
          axios.post("http://192.168.253.177:5001/updateglprofile/"+lead_id,key)
                    .then((res)=>{
                        if(res.data.status==="error"){
                            alert("data are not updated")
                        }
    ...
    return(
        <>
            <h1 className="text-white p-5">Profile</h1>
            <Link to={`/bdm/${id}/${domain}/activity/${lead_id}`}><span className="btn btn-primary float-end">Lead Activity</span></Link>
                ...
                <div class="col-lg-12 login-form  ">
                    ...
                    <form onSubmit={handleupdateglprofile}>
                        ...
                        <div className='col-sm-12 col-md-6 col-lg-4 mt-5'>
                            ...
                            <input type="text" className="form-control" name="emailid" id="emailid" value={email} onChange={(change) => { setEmail(change.target.value) }} />
                            </div>
